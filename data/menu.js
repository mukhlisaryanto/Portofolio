export const menuItems = [
  ...
  { id: 3, href: "/portfolio", icon: "fa-light fa-briefcase", text: "Portofolio" },
...
export const menuItemsTwo = [
  ...
  { id: 3, href: "/portfolio-2", icon: "fa-light fa-briefcase", text: "Portofolio" },
...
export const menuItemsThree = [
  ...
  { id: 3, href: "/portfolio-3", icon: "fa-light fa-briefcase", text: "Portofolio" },
